...
const { getTypes, getTypeById, addType, updateType, deleteType, getTypesWithSkills } = require("../controllers/typesController");
...
route.get("/get-types-with-skills", getTypesWithSkills);
